...
export async function getWarehouseInventory(warehouseId: string, performReconciliation: boolean = false): Promise<WarehouseProduct[]> {
  if (!warehouseId) throw new Error("Warehouse ID is required");
  ...
  // Führe einen manuellen Lagerabgleich durch, aber nur wenn explizit angefordert
