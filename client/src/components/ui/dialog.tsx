    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile styles - full screen or large modal
          isMobile && (mobileFullScreen || false)
            ? "inset-4 p-6 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom sm:rounded-lg"
            : isMobile
            ? "inset-x-4 bottom-0 rounded-t-lg p-6 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
      ...
      >
        ...
        >
          <X className={cn(isMobile ? "h-6 w-6" : "h-4 w-4")} />
    ...
    <div
      className={cn(
        ...
        isMobile 
          ...
          : "flex-row justify-end space-x-2 space-y-0",
        className
      )}
      {...props}
    />
