...
const transactions = [
  {
    ...
    "Machine ID": 323959, // Bad Schandau, Nationalparkbahnhof
...
xlsx.writeFile(workbook, "test_transactions_valid.xlsx");

console.log("Testdatei 'test_transactions_valid.xlsx' wurde erstellt.");