/**
 * Vollständige Lagerbestandsbereinigung 
 * 
 * Dieses Skript führt eine umfassende Bereinigung durch:
 * 1. Identifiziert und konsolidiert Produktduplikate
 * 2. Bereinigt die Lagerbestandstabellen (inventory_items)
 * 3. Aktualisiert Referenzen in inventory_count_items
 * 4. Entfernt doppelte Lagerbestandseinträge
 * 
 * Anwendung: npx tsx scripts/full_inventory_cleanup.ts
 */
 ...
 */
async function cleanupFullInventory() {
  console.log('=================================================');
  console.log('VOLLSTÄNDIGE LAGERBESTAND- UND PRODUKTBEREINIGUNG');
  console.log('=================================================');
  console.log('\nStarte umfassende Bereinigung...');
  ...
  try {
    ...
    // 2. Bereinige Produkte und aktualisiere Referenzen
    console.log('\n2. PRODUKTDUPLIKATE UND REFERENZEN BEREINIGEN');
    console.log('-------------------------------------------');
