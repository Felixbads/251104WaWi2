 ...
 * 
 * Verwendung: node clean_and_resync_warehouse.js [warehouseId]
 * Beispiel: node clean_and_resync_warehouse.js 4
 */
...
async function main() {
  ...
  if (!warehouseId) {
    ...
    console.log('Verwendung: node clean_and_resync_warehouse.js [warehouseId]');
    console.log('Beispiel: node clean_and_resync_warehouse.js 4');
    process.exit(1);
  }
