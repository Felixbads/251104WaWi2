/**
 * Wrapper-Skript für den JSON-Chunks-Import
 * 
 * Dieses Skript steuert den Import der JSON-Chunks in die Datenbank und führt
 * automatisch wiederholte Durchläufe durch, bis alle Chunks importiert sind.
 */
...
const config = {
  ...
  importScript: './import_json_chunks.cjs',
...
async function startImportProcess(maxRuns) {
  console.log('=== STARTE JSON-CHUNKS IMPORT PROZESS ===');
